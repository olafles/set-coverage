...
# for element_index, col_list in enumerate(covers):  # element_index od 0 do 199
#     for col in col_list:
#         column_to_elements[col].add(element_index + 1)  # +1 bo elementy są numerowane od 1

# # Sortowane wypisywanie
