...
class SimulatedAnnealing:
    ...
    def _generate_neighbor(self, solution: Solution) -> Solution:
        ...
        mutation_type = random.choices(
            ["add", "remove", "swap", "optimize", "remove_per_gen", "swap_per_gen"],
        ...
        elif mutation_type == "remove_per_gen":
            neighbor = Mutations.remove_mutation_per_gen(solution, self.validator)
        elif mutation_type == "swap_per_gen":
            neighbor = Mutations.swap_mutation_per_gen(solution, self.validator)
        else:
    ...
    def _plot_progress(self):
        ...
        ax1.set_ylabel("Koszt", color="blue")
